...
if("TRUE" STREQUAL "TRUE")
  set(libfovis_SOURCE_PREFIX /home/nidhi/catkin_scw/src/libfovis)
  set(libfovis_DEVEL_PREFIX /home/nidhi/catkin_scw/devel)
  set(libfovis_INSTALL_PREFIX "")
  set(libfovis_PREFIX ${libfovis_DEVEL_PREFIX})
else()
  set(libfovis_SOURCE_PREFIX "")
  set(libfovis_DEVEL_PREFIX "")
  set(libfovis_INSTALL_PREFIX /home/nidhi/catkin_scw/install)
...
if(NOT "/home/nidhi/catkin_scw/src/libfovis/libfovis " STREQUAL " ")
  set(libfovis_INCLUDE_DIRS "")
  set(_include_dirs "/home/nidhi/catkin_scw/src/libfovis/libfovis")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Pep Lluis Negre <pl.negre@uib.cat>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'libfovis' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'libfovis' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nidhi/catkin_scw/src/libfovis/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT libfovis_NUM_DUMMY_TARGETS)
      set(libfovis_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::libfovis::wrapped-linker-option${libfovis_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR libfovis_NUM_DUMMY_TARGETS "${libfovis_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::libfovis::wrapped-linker-option${libfovis_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND libfovis_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${libfovis_dep}_FOUND)
      find_package(${libfovis_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${libfovis_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
